...
var resizePizzas = function(size) {
    ...
    //fixed FSL becuase used offsetwidth then style.width which caused FSL
    function changePizzaSizes(size) {
        ...
        for (var i = 0; i < randPizzas.length; i++) {
            ...
            //var newwidth = randPizzas[i].offsetWidth + dx) + 'px';
            randPizzas[i].style.width = newwidth + "%";
            //dx and the old newwidth were unnecessary so I put the proper width percentage in the 
            //switch case above and it will assign the new newwidth from there and use it for the width. 
        }
    }
